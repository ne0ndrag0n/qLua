...
static const char qt_meta_stringdata_KahluaIDE[] = {
    "KahluaIDE\0"
};
...
const QMetaObjectExtraData KahluaIDE::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject KahluaIDE::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_KahluaIDE,
      qt_meta_data_KahluaIDE, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &KahluaIDE::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_KahluaIDE))
